...
if(!process.env.SAUCE_USERNAME_ || !process.env.SAUCE_ACCESS_KEY_){
    console.warn(
...
describe('sauce-test (' + desired.browserName + ')', function() {
    var browser;
    var allPassed = true;

    before(function(done) {
        var username = process.env.SAUCE_USERNAME_;
        var accessKey = process.env.SAUCE_ACCESS_KEY_;
